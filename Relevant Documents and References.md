...
* **Formulas for the calculation of Indicators**: [spreadsheet](https://docs.google.com/spreadsheets/d/1XW3JFWwOEP2GzAKgLOjCCQOt0vGXPgzbKxxiIOY8K8w/edit?usp=sharing) developed with Thomas Warichet. This allows to identify the correct DHIS2 dataElements (de) for the calculations. 
* **Mapping of DHIS2 dataElements (ids) to report elements (labels and figures)**. 
	* Same sheet as above, but look at the specific tabs: “[Mapping for Rapport de la Zone](https://docs.google.com/spreadsheets/d/1XW3JFWwOEP2GzAKgLOjCCQOt0vGXPgzbKxxiIOY8K8w/edit?usp=sharing)”, “Mapping for … ”, …
	* Also refer to the documents with the naming of each “visuals” for correct reference and mapping:
