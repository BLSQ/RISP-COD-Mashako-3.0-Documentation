...
* **Mapping of DHIS2 dataElements (ids) to report elements (labels and figures)**. 
	* Same sheet as above, but look at the specific ***tabs***: “[Mapping for Rapport de la Zone](https://docs.google.com/spreadsheets/d/1XW3JFWwOEP2GzAKgLOjCCQOt0vGXPgzbKxxiIOY8K8w/edit?usp=sharing)”, “**Mapping for Rapport de l Antenne**”, "**Mapping for Rapport National**", "**Coherence**" ![[Pasted image 20251229175140.png]]
	* 👉 Also, very IMPORTANT (!), refer to the following documents with the naming of each “visual” (plot and table) for correct reference and mapping. This is needed to understand both the processing in [[(notebook) RUN_1_r_data_transformation_all.ipynb]] and [[(notebook) RUN_3_py_generate_report_filtered.ipynb]]:
		...
		* [[Rapport de bord National - Plots & Tables to reproduce]]
		Also, look at [[Context and Additional Info]] for more explanations on the naming of objects inside the R code for data processing.
